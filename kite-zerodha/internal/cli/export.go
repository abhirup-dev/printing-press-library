...
large datasets as it has no memory pressure.`,
  ...
  kite-zerodha-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  kite-zerodha-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  kite-zerodha-pp-cli export <resource> --format jsonl | jq '.id'`,
