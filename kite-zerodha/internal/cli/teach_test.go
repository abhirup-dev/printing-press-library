...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"kite-zerodha-pp-cli auth login",
		"kite-zerodha-pp-cli doctor",
		"kite-zerodha-pp-cli help items",
		"kite-zerodha-pp-cli sync",
		"kite-zerodha-pp-cli profile list",
		"kite-zerodha-pp-cli feedback list",
		"kite-zerodha-pp-cli which",
		"kite-zerodha-pp-cli agent-context",
		"kite-zerodha-pp-cli completion bash",
		"kite-zerodha-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"kite-zerodha-pp-cli teach",
		"kite-zerodha-pp-cli recall",
		"kite-zerodha-pp-cli learnings",
		"kite-zerodha-pp-cli teach-pattern",
		"kite-zerodha-pp-cli teach-lookup",
		"kite-zerodha-pp-cli items list",
	}
