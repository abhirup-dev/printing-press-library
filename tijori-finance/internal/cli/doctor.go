...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  tijori-finance-pp-cli doctor
  tijori-finance-pp-cli doctor --json
  tijori-finance-pp-cli doctor --fail-on warn
  tijori-finance-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					healthPath := "/company/swiggy-ltd/financials/"
					...
					if authHeader == "" {
						...
						authHeaders["User-Agent"] = "tijori-finance-pp-cli"
						verifyPath := "/in/timeline/upcoming/self"
			...
			// Domain-data cache and sync are intentionally disabled.
			report["cache"] = "disabled (live-only)"
			...
			// Domain-data cache is disabled by contract.
