...
func newCompanyRevenueMixCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "revenue-mix <slug>",
		Short:       "Fetch revenue mix page data",
		Annotations: map[string]string{"pp:endpoint": "company.revenue_mix", "pp:method": "GET", "pp:path": "/company/{slug}/"},
