...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"macro",
		"market",
		"market conglomerate-constituents",
		"market monitor",
		"market sector-constituents",
		"portfolio",
		"portfolio company-summary",
		"portfolio family-company-summary",
		"portfolio family-gainers-losers",
		"portfolio family-summary",
		"portfolio gainers-losers",
		"portfolio summary",
		"raw-materials",
		"reports",
		"reports concalls",
		...
		"reports upcoming",
		"screener",
		"screener advanced-search",
		"screener fields",
		"screener popular",
		"screener popular-results",
		"watchlist",
	}
