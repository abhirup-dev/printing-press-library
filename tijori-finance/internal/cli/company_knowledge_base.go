...
func newCompanyKnowledgeBaseCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "knowledge-base <slug>",
		Short:       "List company report and investor document links",
		Annotations: map[string]string{"pp:endpoint": "company.knowledge_base", "pp:method": "GET", "pp:path": "/company/{slug}/"},
