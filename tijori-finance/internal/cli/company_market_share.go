...
func newCompanyMarketShareCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "market-share <slug>",
		Short:       "Fetch company market-share cards",
		Annotations: map[string]string{"pp:endpoint": "company.market_share", "pp:method": "GET", "pp:path": "/company/{slug}/"},
