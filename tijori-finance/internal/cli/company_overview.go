...
func newCompanyOverviewCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "overview <slug>",
		Short:       "Fetch a company overview page",
		Annotations: map[string]string{"pp:endpoint": "company.overview", "pp:method": "GET", "pp:path": "/company/{slug}/"},
