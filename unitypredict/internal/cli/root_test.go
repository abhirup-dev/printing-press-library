...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"auth-resource",
		"clients",
		"clients list-console",
		"clients list-router",
		"engines",
		"engines create-engines",
		"engines get-buildlogs",
		"engines get-engines",
		"engines get-source-file",
		"engines list-supportedengines",
		"engines list-userengines",
		"fast",
		"models",
		"models create-models",
		"models get-modeldescription",
		"models get-modeldescription-2",
		"models get-models",
		"models get-thumbnail",
		"models list-search",
		"models list-usermodels",
		"payments",
		"predict",
		...
		"social",
		"tools",
		"tools list-analytics",
		"tools list-dev.abhirupdas-8c0af724114435",
	}
