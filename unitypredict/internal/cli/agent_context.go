...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://api.dev.unitypredict.net/api/clients/Console",
		EntryCount:    43,
		APIEntryCount: 43,
		...
		CandidateCommands: []string{
			"create_engines — Derived from observed POST /api/engines traffic.",
			"create_models — Derived from observed POST /api/models traffic.",
			"create_predict — Derived from observed POST /api/predict/{predict_id} traffic.",
			"get_MODELDESCRIPTION — Derived from observed GET /api/models/upload/{upload_id}/MODELDESCRIPTION traffic.",
			"get_SourceFile — Derived from observed GET /api/engines/download/{download_id}/SourceFile traffic.",
			"get_THUMBNAIL — Derived from observed GET /api/models/{model_id}/filekey/THUMBNAIL traffic.",
			"get_THUMBNAIL.png — Derived from observed GET /api/fast/models/{model_id}/files/THUMBNAIL.png traffic.",
			"get_buildlogs — Derived from observed GET /api/engines/buildlogs/{buildlog_id} traffic.",
		},
	}
}
