...
large datasets as it has no memory pressure.`,
  ...
  unitypredict-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  unitypredict-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  unitypredict-pp-cli export <resource> --format jsonl | jq '.id'`,
