...
import (
	...
	"unitypredict-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"unitypredict-pp-cli auth login",
		"unitypredict-pp-cli doctor",
		"unitypredict-pp-cli help items",
		"unitypredict-pp-cli sync",
		"unitypredict-pp-cli profile list",
		"unitypredict-pp-cli feedback list",
		"unitypredict-pp-cli which",
		"unitypredict-pp-cli agent-context",
		"unitypredict-pp-cli completion bash",
		"unitypredict-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"unitypredict-pp-cli recall",
		"unitypredict-pp-cli learnings",
		"unitypredict-pp-cli teach-pattern",
		"unitypredict-pp-cli teach-lookup",
		"unitypredict-pp-cli items list",
	}
