...
but do not stop the import.`,
  ...
  unitypredict-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  unitypredict-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | unitypredict-pp-cli import <resource> --input -`,
