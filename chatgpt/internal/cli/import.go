...
but do not stop the import.`,
  ...
  chatgpt-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  chatgpt-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | chatgpt-pp-cli import <resource> --input -`,
