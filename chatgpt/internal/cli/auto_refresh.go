...
var readCommandResources = map[string][]string{
	"chatgpt-pp-cli conversations":        {"conversations"},
	"chatgpt-pp-cli conversations list":   {"conversations"},
	"chatgpt-pp-cli conversations get":    {"conversations"},
	"chatgpt-pp-cli conversations search": {"conversations"},
	"chatgpt-pp-cli models":               {"models"},
	"chatgpt-pp-cli models list":          {"models"},
	"chatgpt-pp-cli models get":           {"models"},
	"chatgpt-pp-cli models search":        {"models"},
}
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "CHATGPT_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale chatgpt-pp-cli cache (refresh failed: %v)\n", err)
