...
large datasets as it has no memory pressure.`,
  ...
  chatgpt-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  chatgpt-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  chatgpt-pp-cli export <resource> --format jsonl | jq '.id'`,
