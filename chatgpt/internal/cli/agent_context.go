...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		CandidateCommands: []string{
			"create_chat_requirements — Derived from observed POST /backend-api/sentinel/chat-requirements traffic.",
			"create_conversation — Derived from observed POST /backend-api/conversation traffic.",
			"create_prepare — Derived from observed POST /backend-api/f/conversation/prepare traffic.",
			"create_search — Derived from observed POST /backend-api/global/search traffic.",
			"list_6aaa52c7_daec_83ee_9c8a_e1635dbf397e — Derived from observed GET /backend-api/conversations/6aaa52c7-daec-83ee-9c8a-e1635dbf397e traffic.",
			"list_conversations — Derived from observed GET /backend-api/conversations traffic.",
			"list_messages — Derived from observed GET /backend-api/conversations/6aaa52c7-daec-83ee-9c8a-e1635dbf397e/messages traffic.",
			"list_models — Derived from observed GET /backend-api/models traffic.",
		},
	}
}
