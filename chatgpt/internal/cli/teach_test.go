...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"chatgpt-pp-cli auth login",
		"chatgpt-pp-cli doctor",
		"chatgpt-pp-cli help items",
		"chatgpt-pp-cli sync",
		"chatgpt-pp-cli profile list",
		"chatgpt-pp-cli feedback list",
		"chatgpt-pp-cli which",
		"chatgpt-pp-cli agent-context",
		"chatgpt-pp-cli completion bash",
		"chatgpt-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"chatgpt-pp-cli recall",
		"chatgpt-pp-cli learnings",
		"chatgpt-pp-cli teach-pattern",
		"chatgpt-pp-cli teach-lookup",
		"chatgpt-pp-cli items list",
	}
