...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"moneycontrol-pp-cli auth login",
		"moneycontrol-pp-cli doctor",
		"moneycontrol-pp-cli help items",
		"moneycontrol-pp-cli sync",
		"moneycontrol-pp-cli profile list",
		"moneycontrol-pp-cli feedback list",
		"moneycontrol-pp-cli which",
		"moneycontrol-pp-cli agent-context",
		"moneycontrol-pp-cli completion bash",
		"moneycontrol-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"moneycontrol-pp-cli recall",
		"moneycontrol-pp-cli learnings",
		"moneycontrol-pp-cli teach-pattern",
		"moneycontrol-pp-cli teach-lookup",
		"moneycontrol-pp-cli items list",
	}
